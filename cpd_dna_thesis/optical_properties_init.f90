...
contains
  ...
  subroutine optical_properties_init()
    ...
    print*, 'URGENT: op props need source/cited and checked '
 ...
 !THIS NEEDS CHECKED BALANCED AND TIDIED
  !isla everything here needs, search_bisec_modriously, to be checked and cited some of this might be wrong
