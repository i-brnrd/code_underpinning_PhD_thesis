...
contains
  ...
  subroutine optical_properties_init()
    ...
    real*8 lg10
    real*8 :: V_m, v_m_epi   !melanin volumes
    real*8 n_mel !'how many' melanin volumetric cells
    real*8 v_b,sO2, hgb
    ...
    enddo
        ...
        g_all=0.
          lg10 = Log(10.)
          V_m=0.02 !volume of melanin in total.
          v_m_epi=0.04 !volume of melanin in epidermis
          n_mel=(lcount(2)*v_m) ! number of 'melanin voxels' in epidermis
          v_b=0.02   !blood volume only 2% in upper skin
          SO2=0.75
          hgb=150./66500.
      ...
      do i_wl=1,nwl
        ...
        u_a_mel(i_wl)=6.6*(10.**11)*(wl**(-3.33))
      enddo
