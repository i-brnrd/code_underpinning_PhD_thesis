...
!--------------------------------------------------------------------------------
  ...
  write(11,*) 0.00, 1.0
    ...
    open(13,file='./newplots/basal_f.txt',status='replace')
    open(14,file='./newplots/reproduced_spec.txt',status='replace')

    open(15,file='./plots/fluence_depth.txt',status='replace')

    open(16,file='./newplots/toplayer.txt',status='replace')
