...
! open(10,file='./data_out/changes_sandby/density.dat',status='replace')
! do k=1,NZG
...
open(10, file='./data_out/sol_I.dat',status='unknown',form='unformatted')
 read(10) PL_SUM
close(10)
...
open(10,file='./data_out/basal_datasets/sol_I.dat',status='replace')
